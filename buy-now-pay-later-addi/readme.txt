...
* Improved the check for the WooCommerce Channel.

= 1.9.2 2024-07-03 =
* Fixed the title for BNPN by making it dynamic

= 1.9.1 2024-07-02 =
* Fixed with the version variable
* Fixed code deprecated and the wrong way to do it
* The visual of BNPN screen at checkout was improved in a responsive way

= 1.9.0 2024-04-10 =
* Fixed the error in the appearance of the checkout description with other plugins
* Fixed the bug that made multiple calls to addi services unnecessarily
* The visual of the logos at checkout was improved
* The configuration visual was improved to avoid ambiguity

= 1.8.11 2024-04-04 =
* fix totals wrong validation
* The tested version of WordPress was updated with the latest 6.5

= 1.8.10 2024-03-22 =
* fixing init bug

= 1.8.9 2024-03-22 =
* fixing no requested value and adding new icons

= 1.8.8 2024-03-20 =
* Adding copy to the BNPN option

= 1.8.7 2024-01-18 =
* Fix bug credentials

= 1.8.6 2023-12-13 =
* Fix hook to init callback_handler function

= 1.8.5 2023-12-13 =
* Fix auth validation

= 1.8.4 2023-12-13 =
* Fix redirection without addi cookie

= 1.8.3 2023-10-31 =
* Fix wrong accent

= 1.8.2 2023-10-26 =
* Fix the redirection for a abandoned origination

= 1.8.1 2023-10-25 =
* Update checkout description

= 1.8.0 2023-10-13 =
* Support for Pay Now checkout
